...
const _YggdrasilSerializer = preload("res://addons/yggdrasil/scripts/runtime/yggdrasil_serializer.gd")
...
func build() -> YggdrasilTreeView:
	...
	if not Engine.is_editor_hint():
		var _ser := _YggdrasilSerializer.new()
		_ser.load_tree_state(_tree, _save_path)
